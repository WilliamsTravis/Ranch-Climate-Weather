...
Created on Wed Nov 22 08:48:09 2017
    ...
    This is to extract rasters from these huge PRISM datasets. It's tricky to me because they are
        organized by month, each with 123 years worth of data for that month.
...
import os
import sys
os.chdir(r'G:\My Drive\NOT THESIS\Shrum-Williams\project')
sys.path.append('Python\\functions.py')
