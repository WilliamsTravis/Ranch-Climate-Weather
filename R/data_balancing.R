...
# Read in df
df0 = readRDS("data/tables/noaa_500_standardized.rds")
df = df0[1:14]
just_rain = readRDS("data/tables/just_precip_standardized.rds")
names(just_rain) = tolower(names(just_rain))
justrain = getMonths(just_rain)
